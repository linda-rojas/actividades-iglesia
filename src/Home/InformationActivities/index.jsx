...
export function InformationActivities(
    ...
    return (
        <div className='w-full max-w-[350px] max-h-[140px] flex bg-white shadow-slate-700 shadow-md min-w-full rounded-bl-lg'>
            ...
            <div className='flex flex-col'>
                    <span className='font-roboto font-medium text-[20px] text-center self-center text-gray-600 w-[230px]'>{title}</span>
