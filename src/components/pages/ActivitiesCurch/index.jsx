...
export const ActivitiesCurch = () => {
    ...
    return (
        <div>
            <header className='xs:gap-[4.5rem] xs:h-[60px] s:h-[65px] bg-blue-700 flex s:gap-[6rem] items-center w-full'>
            <Link to={home}>
                <article className='flex ml-5'>
                    <ChevronLeftIcon className='w-5 h-[3rem] text-white' stroke='currentColor'/>
                </article>
            </Link>
                <h1 className='text-center font-roboto font-semibold xs:text-[24px] s:text-[27px] text-white select-none '>Iglesia la plata</h1>
            </header>
            <section className='relative top-[3rem] select-none mb-[5rem] flex flex-wrap flex-col items-center lg:flex-row gap-10'>
