...
export function InformationSector(
    ...
    return (
        <div className='xs:max-w-[270px] s:max-w-[340px] xs:min-h-[50px] s:min-h-[60px]  w-full flex bg-white shadow-slate-700 shadow-md rounded-[0.4rem]'>
            <div className='xs:min-w-[62px] s:min-w-[80px] bg-green-700 text-white items-center justify-center flex flex-col rounded-l-[0.4rem]'>
