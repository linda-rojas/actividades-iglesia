    ...
    return (
        <div className='xs:max-w-[275px] s:max-w-[330px] xs:min-h-[100px] s:min-h-[120px] w-full flex bg-white rounded-[0.8rem] shadow-slate-700 shadow-md'>
            <figure className='w-[220px]'>
                <img 
                    className='object-cover max-h-[155px] w-[130px] rounded-l-[0.8rem]'
                    src={imageCard} 
                    alt='image-card' />
            </figure>
            <div className='flex flex-col w-full justify-center items-center s:gap-[3px]'>
                    ...
                    <p className='text-[14px] w-[180px] font-roboto font-light text-description text-center'>{description}</p>
