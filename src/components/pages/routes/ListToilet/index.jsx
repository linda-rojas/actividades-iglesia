...
export const ListToilet = () => {
    ...
    return (
        <div>
            ...
            <div className='xs:h-12 s:h-10 xs:min-w-[320px] s:min-w-[365px] flex items-center justify-around xs:text-[17px] s:text-[18px] font-medium text-white bg-yellow-600'>
                <span>Sábado</span>
